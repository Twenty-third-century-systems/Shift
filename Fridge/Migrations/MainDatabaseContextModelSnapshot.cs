...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fridge.Models.ApplicationStatus", b =>
                {
            ...
            modelBuilder.Entity("Fridge.Models.PrivateEntity", b =>
                {
                    ...
                    b.HasIndex("LastApplicationId")
                        .IsUnique()
                        .HasFilter("[last_application] IS NOT NULL");
            ...
            modelBuilder.Entity("Fridge.Models.PrivateEntityOffice", b =>
                {
                    b.Property<int>("PrivateEntityOfficeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("PrivateEntityOfficeId");
            ...
            modelBuilder.Entity("Fridge.Models.PrivateEntityRoles", b =>
                {
                    b.Property<int>("PrivateEntityRolesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id")
                        .UseIdentityColumn();
            ...
            modelBuilder.Entity("Fridge.Models.PrivateEntitySubscriber", b =>
                {
                    ...
                    b.Property<bool>("IsARepresentative")
                        .HasColumnType("bit")
                        .HasColumnName("Represants");
            ...
            modelBuilder.Entity("Fridge.Models.ReasonForNameSearch", b =>
                {
                    b.Property<int>("ReasonForNameSearchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("ReasonForNameSearchId");
            ...
            modelBuilder.Entity("Fridge.Models.EntityName", b =>
                {
                    ...
                    b.HasOne("Fridge.Models.ApplicationStatus", "ApplicationStatus")
                        .WithMany("EntityNames")
            ...
            modelBuilder.Entity("Fridge.Models.NameSearch", b =>
                {
                    ...
                    b.HasOne("Fridge.Models.ReasonForNameSearch", "ReasonForNameSearch")
                        .WithMany("NameSearches")
                    ...
                    b.HasOne("Fridge.Models.ServiceApplication", "ServiceApplication")
                        .WithOne("NameSearch")
                        .HasForeignKey("Fridge.Models.NameSearch", "ServiceApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ReasonForNameSearch");
            ...
            modelBuilder.Entity("Fridge.Models.PrivateEntity", b =>
                {
                    b.HasOne("Fridge.Models.ServiceApplication", "ServiceApplication")
                        .WithOne("PrivateEntity")
                        .HasForeignKey("Fridge.Models.PrivateEntity", "ApplicationId")
                        .IsRequired();
                    ...
                    b.HasOne("Fridge.Models.PrivateEntityOffice", "PrivateEntityOffice")
                        .WithMany("PrivateEntities")
                        .HasForeignKey("EntityOfficeId");

                    b.HasOne("Fridge.Models.ServiceApplication", "LastApplication")
                        .WithOne("PrivateEntityLastApplication")
                        .HasForeignKey("Fridge.Models.PrivateEntity", "LastApplicationId");
                    ...
                    b.Navigation("PrivateEntityOffice");
            ...
            modelBuilder.Entity("Fridge.Models.PrivateEntityHasSubscriber", b =>
                {
                    ...
                    b.HasOne("Fridge.Models.PrivateEntityRoles", "RolesInPrivateEntityRoles")
                    ...
                    b.Navigation("RolesInPrivateEntityRoles");
            ...
            modelBuilder.Entity("Fridge.Models.PrivateEntitySubscriber", b =>
                {
                    b.HasOne("Fridge.Models.ForeignEntity", "ForeignEntity")
                        .WithMany()
                        .HasForeignKey("ForeignEntityId");
            ...
            modelBuilder.Entity("Fridge.Models.ServiceApplication", b =>
                {
                    ...
                    b.Navigation("PrivateEntityLastApplication");
                });
