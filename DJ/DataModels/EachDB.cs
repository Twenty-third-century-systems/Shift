...
namespace DJ.DataModels
{
	...
	{
		[Column("id"),             PrimaryKey,  Identity] public int  Id            { get; set; } // int
		[Column("user_id"),         NotNull              ] public string  UserId        { get; set; } // nvarchar(max)
		[Column("date_submitted"),         NotNull              ] public DateTime  DateSubmitted        { get; set; } // nvarchar(max)
	...
	public partial class Office
	{
		...
		[Column("country_code"),     NotNull             ] public string CountryCode     { get; set; } // nvarchar(45)
	...
	public partial class PvtEntity
	{
		...
		[Column("name_id"),                          NotNull] public int      NameId            { get; set; } // int
		[Column("office_id"),                        NotNull] public int      OfficeId          { get; set; } // int
		[Column("articles_id"),                      NotNull] public int      ArticlesId        { get; set; } // int
		[Column("memorundum_id"),                    NotNull] public int      MemorundumId      { get; set; } // int
		[Column("reference"),              Nullable         ] public string   Reference         { get; set; } // nvarchar(45)
	}
