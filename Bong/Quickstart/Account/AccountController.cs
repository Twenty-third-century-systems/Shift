...
namespace IdentityServerHost.Quickstart.UI 
{
    ...
    public class AccountController : Controller {
        ...
        [HttpPost]
        public async Task<IActionResult> Register(RegistrationDto newUserInformation)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    MiddleName = newUserInformation.MiddleName,
                    Surname = newUserInformation.Surname,
                    NationalId = newUserInformation.NationalId,
                    Office = newUserInformation.Office,
                    Address = new Address
                    {
                        ResidentialAddress = newUserInformation.ResidentialAddress,
                        City = newUserInformation.City
                    },
                    Email = newUserInformation.Email,
                    PhoneNumber = newUserInformation.PhoneNumber,
                    UserName = newUserInformation.Email
                };
